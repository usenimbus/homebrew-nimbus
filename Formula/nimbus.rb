...
class Nimbus < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/usenimbus/homebrew-nimbus/releases/download/v1.0.4/nimbus-1.0.4-darwin-arm64.tar.gz"
  ...
  if Hardware::CPU.intel?
    url "https://github.com/usenimbus/homebrew-nimbus/releases/download/v1.0.4/nimbus-1.0.4-darwin-amd64.tar.gz"
